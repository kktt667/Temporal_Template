...
import { ChildWorkflowOptions, ChildWorkflowOptionsWithDefaults, ContinueAsNewOptions, DefaultSignalHandler, EnhancedStackTrace, Handler, QueryHandlerOptions, SignalHandlerOptions, UpdateHandlerOptions, WorkflowInfo, UpdateInfo } from '@temporalio/workflow/lib/interfaces';
import { ChildWorkflowHandle, ExternalWorkflowHandle } from '@temporalio/workflow/lib/workflow-handle';
/**
