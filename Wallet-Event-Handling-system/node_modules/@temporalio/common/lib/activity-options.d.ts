...
import { RetryPolicy } from '@temporalio/common/lib/retry-policy';
import { Duration } from '@temporalio/common/lib/time';
import { VersioningIntent } from '@temporalio/common/lib/versioning-intent';
...
export declare const encodeActivityCancellationType: (input: coresdk.workflow_commands.ActivityCancellationType | import("@temporalio/common/lib/type-helpers").RemovePrefix<"", "TRY_CANCEL" | "WAIT_CANCELLATION_COMPLETED" | "ABANDON"> | null | undefined) => coresdk.workflow_commands.ActivityCancellationType | undefined, decodeActivityCancellationType: (input: coresdk.workflow_commands.ActivityCancellationType | null | undefined) => import("@temporalio/common/lib/type-helpers").RemovePrefix<"", "TRY_CANCEL" | "WAIT_CANCELLATION_COMPLETED" | "ABANDON"> | undefined;
/**
