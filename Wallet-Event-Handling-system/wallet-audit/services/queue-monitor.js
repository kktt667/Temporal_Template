        ...
        try {
            switch (command) {
                ...
                default:
                    ...
                    console.log('');
                    console.log('Usage:');
                    console.log('  node wallet-audit/services/queue-monitor.js start    (start monitoring)');
                    console.log('  node wallet-audit/services/queue-monitor.js clear    (clear all queues)');
                    console.log('  node wallet-audit/services/queue-monitor.js stats    (show current stats)');
                    console.log('');
